        ...
        <section>
            <div className="navbar bg-customColor flex justify-between items-center px-4">
                ...
                <div className="navbar-center text-white hidden lg:flex space-x-4">
                    ...
                    <Link to="/renta" className="btn btn-ghost text-xl">Agenda una visita</Link>
                ...
                <div className="navbar-end flex items-center">
                    ...
                    <div className="hidden lg:flex items-center">
                        <span className="text-white mr-2">Hola {user?.nombre?.split(' ')[0]}</span>
            ...
            {isOpen && (
                <div className="lg:hidden">
                    <div className="flex flex-col items-start space-y-2 p-4 text-white font-roboto">
                        ...
                        <Link to="/renta" className="btn btn-ghost text-xl" onClick={toggleMenu}>Agenda una visita</Link>
